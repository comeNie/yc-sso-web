...
<head>
    ...
    <title>login</title>
	<link href="${_base}/theme/yeekit/css/bootstrap/font-awesome.css" rel="stylesheet" type="text/css">
	<link href="${_base}/theme/yeekit/css/iconfont.css" rel="stylesheet" type="text/css">
	<link href="${_base}/theme/yeekit/css/modular/global.css" rel="stylesheet" type="text/css"/>
	<link href="${_base}/theme/yeekit/css/modular/login-regsiter.css" rel="stylesheet" type="text/css"/>
...
<script type="text/javascript" src="${_base}/theme/yeekit/js/placeholder.min.js"></script>
<script type="text/javascript" src="${_base}/theme/yeekit/js/datacheck.js" ></script>
